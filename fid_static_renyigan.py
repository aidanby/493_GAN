...
def main():
    ...
    while trial_num < 11:
        ...
        for epoch in range(250):
            p = np.load('data/v' + str(version) + '/trial' +
                        str(trial_num) + '/alpha' + str(alpha) + '/predictions' + str(epoch) + '.npy')
...
if __name__ == "__main__":
    alpha_num, ver = input("Alpha, version: ").split()
    main()
